class MobiusCli < Formula
  ...
  on_macos do
    ...
    on_arm do
      url "https://github.com/citizenhicks/mobius/releases/download/mobius-cli-v0.15.42/mobius-0.15.42-aarch64-apple-darwin.tar.gz"
      sha256 "f113df8246745ad092f6e7cf69b8f1581b8a9201ce73638e883ad1245da77311"
    end
  end
  ...
  on_linux do
    ...
    on_intel do
      url "https://github.com/citizenhicks/mobius/releases/download/mobius-cli-v0.15.42/mobius-0.15.42-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "b79286fa554dd1abf440b6b060c8f814d3635ab423d273eb879ec2e761256905"
    end
  end
